...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "daz-sk-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/kite-server"
  #   chef.validation_client_name = "kite-server-validator"
  #   chef.validation_key_path = ".chef/kite-server-validator.pem"
  # end
end
